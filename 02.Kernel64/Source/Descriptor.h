 ...
 * GDT_TYPE_DATA USAGE!!
 *
 * (GDT_TYPE_DATA_READ | GDT_TYPE_DATA_RDWR) | [GDT_TYPE_DATA_ACCESS] | [GDT_TYPE_DATA_REVERSE]
 *
 */
#define GDT_TYPE_DATA_READ 		0x00
#define GDT_TYPE_DATA_RDWR 		0x02
#define GDT_TYPE_DATA_ACCESSED 	0x01
#define GDT_TYPE_DATA_REVERSE 	0x04

/*
 * GDT_TYPE_CODE USAGE!!
 *
 * (GDT_TYPE_CODE_EXEC | GDT_TYPE_CODE_EXRD) | [GDT_TYPE_CODE_ACCESSED] | [GDT_TYPE_CODE_CONFIRM]
 *
 */
#define GDT_TYPE_CODE_EXEC		0x08
#define GDT_TYPE_CODE_EXRD		0x0A

#define GDT_TYPE_CODE_ACCESSED	0x01
#define GDT_TYPE_CODE_CONFIRM 	0x04
/*
 * GDT_TYPE_SYSTEM_....
 * 나중에 채우도록
 */
#define GDT_TYPE_CODE GDT_TYPE_CODE_EXRD
#define GDT_TYPE_DATA GDT_TYPE_DATA_RDWR
#define GDT_TYPE_TSS 			0x09
/*
 * GDT_FLAG_LOWER
 * (GDT_FLAGS_LOWER_S | (GDT_FLAGS_LOWER_DPL0 | GDT_FLAGS_LOWER_DPL1 | GDT_FLAGS_LOWER_DPL2 | GDT_FLAGS_LOWER_DPL3) | GDT_FLAGS_LOWER_P
 */
#define GDT_FLAGS_LOWER_S		0x10 //세그먼트 디스크립터(code data)라면 on
...
#define GDT_FLAGS_LOWER_P		0x80 //Present 비트 유효한 디스크립터라면 on
/*
 * GDT_FLAG_UPPER
 *
 */
#define GDT_FLAGS_UPPER_L		0x20 //64bit이면 on 32bit이면 no
#define GDT_FLAGS_UPPER_DB		0x40 //32bit이면 on 16bit이면 no
#define GDT_FLAGS_UPPER_G		0x80 //세그먼트 사이즈 곱하기
//실제 사용 매크로
...
#define GDT_FLAGS_LOWER_KERNELDATA 	(GDT_TYPE_DATA | GDT_FLAGS_LOWER_S | \
		GDT_FLAGS_LOWER_DPL0 | GDT_FLAGS_LOWER_P)
#define GDT_FLAGS_LOWER_TSS 		(GDT_TYPE_TSS | GDT_FLAGS_LOWER_P)
...
#define GDT_FLAGS_LOWER_USERDATA 	(GDT_TYPE_DATA | GDT_FLAGS_LOWER_S | \
		GDT_FLAGS_LOWER_DPL3 | GDT_FLAGS_LOWER_P)
#define GDT_FLAGS_UPPER_CODE 		(GDT_FLAGS_UPPER_L | GDT_FLAGS_UPPER_G)
#define GDT_FLAGS_UPPER_DATA 		(GDT_FLAGS_UPPER_L | GDT_FLAGS_UPPER_G)
