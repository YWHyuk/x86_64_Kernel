...
void InitializeLinkedListManger(LINKEDLISTMANAGER* LinkedListManager){
	...
	LinkedListManager->Max_Count = TASK_MAXCOUNT;
}
...
void Print_LinkedList(LINKEDLISTMANAGER* LinkedListManager){
	LINKEDLIST* Iterator;
	kPrintf("LINKEDLISTMANAGER\n");
	kPrintf("Begin:%q\t End:%q\t Count:%d\n",\
